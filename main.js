...
Game.Launch=function()
{
	...
	Game.Logic=function()
	{
		...
		{
			var title='Priority - Google Drive';
			if (Game.season=='fools') title='Proirity - Google Droove';
			document.title=(Game.OnAscend?(EN?'Ascending! ':(loc("Ascending")+' | ')):'')+loc("",LBeautify(Game.cookies))+''+title;  //i deleted code hereeee
		}
		if (Game.T%15==0)
		{
